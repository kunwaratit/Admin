...
<div class="left-content" style="margin-top:-1px;border-radius:12px; display: flex; flex-direction: column; align-items: center; background: #d61b1b; height:fit-content;">
        ...
        <div class="user-status-wrapper" id="user_status">
            ...
            <div style="line-height:1.4;  color:#d6f09d;font-weight: 600;">
                <div style="text-align:center;">
                    ...
                    ?>
                    <div style="color:bisque;font-size: 14px;">UserId-<?php
                ...
                <div style="color:bisque;"><a href='tel:<?php
                                                        ...
                                                        ?>' style="color:white ;"><?php
                                                                                    echo $_SESSION['phone']; ?></a>
                </div>

                <div>Donated on <span>25 sept,2020</span></div>
                <div>Donated : <span>5 </span>times</div>

            </div>
            <button><a href="./template/logout.php">Log Out</a></button>
        </div>
        <div>
